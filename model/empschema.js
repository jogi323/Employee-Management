...
var schema = new Schema({
    ...
    companyEmail: {type: String, required: false, unique: true},
    ...
    reportingTo: [{type: Schema.Types.String, ref: 'Employee'}],
    reportingToHim: [{type: Schema.Types.String, ref: 'Employee'}],
